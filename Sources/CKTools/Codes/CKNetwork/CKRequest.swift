...
public typealias CKHttpCompletion = (_ request:CKRequest) -> Void

open class CKRequest: NSObject {
    ...
    public private(set) var httpCompletion:CKHttpCompletion?
    public private(set) var startTime:Double = 0
    public private(set) var cookies:String?

    public init(httpCompletion:CKHttpCompletion?) {
    ...
    public final func start() {
        ...
        CKHttpClient.shared.add(request: self)
